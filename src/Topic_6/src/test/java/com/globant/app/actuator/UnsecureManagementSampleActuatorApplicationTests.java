...
package com.globant.app.actuator;
...
/**
 * Integration tests for unsecured services endpoints (even with Spring Security on
 * classpath).
 * 
 * @author Dave Syer
 */
@RunWith(SpringJUnit4ClassRunner.class)
@SpringApplicationConfiguration(classes = MeetingsWebService.class)
@WebAppConfiguration
